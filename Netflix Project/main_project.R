netflix_csv <- read.csv("C:/Netflix Project/netflix_titles.csv")
...
netflix_cleaned <- netflix_csv %>% 
  ...
  mutate(
    ...
    duration_type = str_extract(duration, "[A-Za-z]+")
  ) 
  
View(netflix_cleaned)
...
netflix_colors <- c("United States"="#E50914","India"="#B81D24","United Kingdom"="#A93226","Canada"="#922B21","France"="#831010", 
                  "Japan"="#6A1010","Spain"="#5A1515","South Korea"="#4A1A1A","Germany"="#3A3A3A","Mexico"="#2A2A2A")
